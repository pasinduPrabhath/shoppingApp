...
const Cart1 = () => {
  ...
  const handlePurchase = () => {
    ...
    axios.post('PURCHASE_API_URL', purchaseData)
      .then(response => {
      ...
      <div className="grid grid-cols-4 bg-white">
        ...
        <div className="grid grid-cols-7 text-center my-8 mx-16 bg-gray-100">
          ...
          {cartItems.map((item, index) => (
            <div key={index} className="grid grid-cols-7 h-36 text-center m-16 mt-0 shadow-md rounded-md">
              <div className="flex justify-center font-medium items-center w-full col-span-1">
              ...
              <div className="flex justify-center font-medium items-center w-full col-span-1">
                <button className="hover:cursor" onClick={() => removeFromCart(index)}>
                  Remove
                </button>
              </div>
            </div>
